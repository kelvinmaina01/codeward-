...
export function FooterTrustBadges() {
  return (
    <div className="flex flex-wrap items-center justify-center lg:justify-start gap-x-6 gap-y-4 max-w-2xl">
      {/* 1. ISO 27001 Certified */}
      <div className="flex items-center gap-2.5">
        <svg className="w-8 h-8 text-slate-700 shrink-0" viewBox="0 0 36 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="leading-tight">
          <div className="text-[13px] font-bold text-slate-900 tracking-tight">ISO 27001</div>
          <div className="text-[11px] font-medium text-slate-600">Certified</div>
        </div>
      </div>

      {/* 2. GDPR Compliant */}
      <div className="flex items-center gap-2.5">
        <svg className="w-8 h-8 text-slate-700 shrink-0" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* 10 stars circle */}
        ...
        <div className="leading-tight">
          <div className="text-[13px] font-bold text-slate-900 tracking-tight">GDPR</div>
          <div className="text-[11px] font-medium text-slate-600">Compliant</div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2.5">
        <svg className="w-8 h-8 text-slate-700 shrink-0" viewBox="0 0 36 40" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M16 20L17.5 21.5L20 18.5" stroke="#C3DBFF" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
        <div className="leading-tight">
          <div className="text-[13px] font-bold text-slate-900 tracking-tight">CCPA</div>
          <div className="text-[11px] font-medium text-slate-600">Compliant</div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="leading-tight">
          <div className="text-[13px] font-bold text-slate-900 tracking-tight">HIPAA</div>
          <div className="text-[11px] font-medium text-slate-600">Compliant</div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="leading-tight">
          <div className="text-[13px] font-bold text-slate-900 tracking-tight">256-bit SSL</div>
          <div className="text-[11px] font-medium text-slate-600">Encrypted</div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="leading-tight">
          <div className="text-[13px] font-bold text-slate-900 tracking-tight">99% Accuracy</div>
          <div className="text-[11px] font-medium text-slate-600">Guarantee</div>
        </div>
      </div>
    </div>
  );
