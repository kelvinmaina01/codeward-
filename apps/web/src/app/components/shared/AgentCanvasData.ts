...
export const agentCanvasData: AgentData[] = [
  {
    ...
    progress: 100,
    color: '#8B5CF6',
    metrics: [{ t: 'Orchestrator', c: 'purple' }],
    logs: [
      { t: '--', type: 'info', msg: 'Orchestrator ready on standby. Waiting for pipeline events.' },
    ],
    config: { model: '', trigger: 'webhook/push', mode: 'parallel-dispatch' },
    findings: [],
    sandbox: [],
  ...
  },
  {
    ...
    config: { model: '', tools: 'trufflehog,trivy,owasp-zap,auth-probe' },
    findings: [],
    sandbox: [],
    summary: { criticals: 0, highs: 0, mediums: 0, fixed: 0, linesRemoved: 0, duration: '0s' },
  },
  {
    ...
    config: { model: '', tools: 'fallow-cli,tree-sitter,bundle-analyser' },
    findings: [],
    sandbox: [],
    summary: { criticals: 0, highs: 0, mediums: 0, fixed: 0, linesRemoved: 0, duration: '0s' },
  },
  {
    ...
    config: { model: '', tools: 'jest,heap-profiler,async-ast-scan' },
    findings: [],
    sandbox: [],
    summary: { criticals: 0, highs: 0, mediums: 0, fixed: 0, linesRemoved: 0, duration: '0s' },
  },
  {
    ...
    config: { model: '', tools: 'k6,pg-explain,import-tracer' },
    findings: [],
    sandbox: [],
    summary: { criticals: 0, highs: 0, mediums: 0, fixed: 0, linesRemoved: 0, duration: '0s' },
  },
  {
    ...
    config: { model: '', tools: 'ai-pattern-detector,llm-injection-audit' },
    findings: [],
    sandbox: [],
    summary: { criticals: 0, highs: 0, mediums: 0, fixed: 0, linesRemoved: 0, duration: '0s' },
  },
  {
    ...
    config: { model: '', tools: 'github-checks,pr-reviewer,auto-merge' },
    findings: [],
    sandbox: [],
    summary: { criticals: 0, highs: 0, mediums: 0, fixed: 0, linesRemoved: 0, duration: '0s' },
  },
  {
    ...
    config: { model: '', tools: 'license-checker,soc2-audit,gdpr-probe' },
    findings: [],
    sandbox: [],
    summary: { criticals: 0, highs: 0, mediums: 0, fixed: 0, linesRemoved: 0, duration: '0s' },
  },
  {
    ...
    config: { model: '', tools: 'data-pipeline-analyzer,schema-contract-checker' },
    findings: [],
    sandbox: [],
    summary: { criticals: 0, highs: 0, mediums: 0, fixed: 0, linesRemoved: 0, duration: '0s' },
  },
  {
    ...
    progress: 0,
    color: '#ec4899',
    metrics: [{ t: 'Always on', c: 'purple' }],
    logs: [
      { t: '--', type: 'info', msg: 'Chat Agent ready on standby. Ask anything about your repositories.' },
    ],
    config: { model: '', trigger: 'always-on', tools: 'query_history,spawn_agent' },
    findings: [],
    sandbox: [],
    summary: { criticals: 0, highs: 0, mediums: 0, fixed: 0, linesRemoved: 0, duration: '0s' },
  }
