...
// ============================================================
// Codeward Hero Section â€” Self-contained single-file component
  ...
  const initialFaqs = [
    {
      ...
      answer: "No. While tools like CodeRabbit focus heavily on PR summaries and superficial code review comments, Codeward is an active participant in your codebase. We don't just leave commentsâ€”our autonomous agents actively write the code, generate the fixes, and manage your technical debt directly."
    },
    {
  ...
  const advancedFaqs = [
    {
      ...
      answer: "Codeward deploys specialized sub-agentsâ€”like an Architecture Agent, a Testing Agent, and a Security Agentâ€”that collaborate. They review the codebase simultaneously, discuss optimal solutions in the background, and then execute complex, multi-file refactors that a single model couldn't handle."
    },
    {
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-12 flex justify-center">
              ...
              >
                ...
                <span className={`transition-transform duration-300 ${showMore ? 'rotate-180' : ''}`}>â†“</span>
              </button>
            </div>
          </div>
        </div>
    ...
    <section className="bg-[#05060a] pt-20 md:pt-24 pb-20 md:pb-24 px-8 md:px-20 font-['DM_Sans'] relative overflow-hidden">
      <FadeInSection>
        <div className="mx-auto max-w-[1200px] relative z-10">
          ...
          {/* Learn more button â€” right aligned */}
        ...
        {/* Dot pattern â€” absolute to the section, completely independent of content flow */}
...
function TestimonialsSection() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      text: (
        <>
          It's not just another chatbot that you have to micromanage. Codeward acts like a true senior engineerâ€”<span className="bg-yellow-300 text-black px-1 rounded-sm">autonomously refactoring</span> legacy code and writing comprehensive test suites without needing my constant supervision.
        </>
      ),
      author: "John Smith",
      role: "CTO, StartupInc",
    ...
    },
    {
      ...
      text: (
        <>
          The Review Agent is a total game-changer. It doesn't just leave vague comments on PRsâ€”it <span className="bg-yellow-300 text-black px-1 rounded-sm">spins up sandboxes</span>, runs the failing tests, and commits self-healing patches instantly. Our velocity has literally doubled.
        </>
      ),
      author: "David Lee",
...
export default function CodewardHero() {
  ...
  return (
    <div className="h-screen overflow-y-auto overflow-x-hidden bg-[#05060a]">
        ...
        <div className="max-w-2xl">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            >
              ...
              <span className="mr-2">Connect repo â†’</span>
            </button>
          </div>
      ...
      {/* â”€â”€ Social Proof / Trusted By Section â”€â”€ */}
      ...
      {/* â”€â”€ Mission Statement Section â”€â”€ */}
      <section 
      ...
      {/* â”€â”€ Specialized AI Agents Section â”€â”€ */}
      <section className="bg-[#05060a] py-20 md:py-24 px-8 md:px-20 border-t border-white/5">
      ...
      {/* â”€â”€ Flow / Architecture Section â”€â”€ */}
      ...
      {/* â”€â”€ Latest Insights / Blogs Section â”€â”€ */}
