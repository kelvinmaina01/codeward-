        ...
        <div className="w-full md:w-1/2 flex flex-col items-center justify-center px-4 md:px-12 py-12 relative text-white font-['Google_Sans_Flex']">
          <div className="relative z-10 flex flex-col items-center text-center w-full max-w-xl">
            ...
            <div className="absolute bottom-12 left-0 right-0 flex flex-col items-center gap-4">
              <span className="text-[13px] font-bold text-white/50 tracking-wider uppercase">Join our dev community</span>
              <div className="flex items-center gap-4">
                <a href="#" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-white/5 hover:border-white/20 hover:scale-105 transition-all text-[#25D366]">
                  {/* WhatsApp */}
                ...
                <a href="#" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-white/5 hover:border-white/20 hover:scale-105 transition-all text-[#5865F2]">
                  {/* Discord */}
