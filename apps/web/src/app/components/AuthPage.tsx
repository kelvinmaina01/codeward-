      ...
      <div className="w-full h-full max-w-[1600px] flex gap-6 md:gap-8 flex-col md:flex-row items-stretch justify-center relative z-10" style={{ minHeight: 'calc(100vh - 24px)' }}>
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center justify-center px-4 md:px-12 py-12 relative text-white font-['Google_Sans_Flex']">
          <div className="relative z-10 flex flex-col items-center text-center w-full max-w-xl">
            ...
            {/* Dev Community Card */}
            <div className="mt-16 flex flex-col items-center gap-5 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 w-full max-w-[340px]">
              <span className="text-[12px] font-bold text-white/60 tracking-widest uppercase">Join our dev community</span>
              <div className="flex items-center gap-6">
                <a href="#" className="w-14 h-14 rounded-full bg-[#25D366]/10 border border-[#25D366]/20 flex items-center justify-center hover:bg-[#25D366]/20 hover:scale-105 transition-all text-[#25D366] shadow-[0_0_20px_rgba(37,211,102,0.15)]">
                  {/* WhatsApp */}
                ...
                <a href="#" className="w-14 h-14 rounded-full bg-[#5865F2]/10 border border-[#5865F2]/20 flex items-center justify-center hover:bg-[#5865F2]/20 hover:scale-105 transition-all text-[#5865F2] shadow-[0_0_20px_rgba(88,101,242,0.15)]">
                  {/* Discord */}
